    ...
    browse: function(modalUrl,zoneId,melisKey,params, targetDiv) {
        ...
        melisHelper.createModal(zoneId,melisKey,false,params,modalUrl, function() {
            ...
            if ( $(targetDiv).length > 0 ) {
                var $body               = $("body"),
                    categoryAddImage    = $(".category-add-image"),
                    currentPosition     = categoryAddImage.data('currentposition'),
                    categoryAddFile     = $(".category-add-file"),
                    currentPositionFile = categoryAddFile.data('currentposition');
                        ...
                        var $this   = $(this),
                            ...
                            if ( data.fileType === 'image' ) {
                                ...
                                html  = "<div id='"+ currentPosition  +"' class='col-md-12 margin-b-10 category-image'>" +
                                    "<img src='" + data.imageUrl + "' class='img-fluid border-green' />" +
