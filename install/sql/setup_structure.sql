...
`cat2_date_creation` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Data for table `melis_cms_category2`
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_cms_category2` (`cat2_id`, `cat2_father_cat_id`, `cat2_order`, `cat2_status`, `cat2_reference`, `cat2_date_valid_start`, `cat2_date_valid_end`, `cat2_date_creation`, `cat2_user_id_creation`, `cat2_date_edit`, `cat2_user_id_edit`) VALUES (1, -1, 1, 1, NULL, NULL, NULL, DEFAULT, 1, NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `melis_cms_category2_trans`
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_cms_category2_trans` (`catt2_id`, `catt2_category_id`, `catt2_lang_id`, `catt2_name`, `catt2_description`) VALUES (1, 1, 1, 'My catalog', NULL);
INSERT INTO `melis_cms_category2_trans` (`catt2_id`, `catt2_category_id`, `catt2_lang_id`, `catt2_name`, `catt2_description`) VALUES (2, 1, 2, 'Mon catalogue', NULL);
